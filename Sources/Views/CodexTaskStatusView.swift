...
struct CodexTaskStatusGlyph: View {
    ...
    static func color(for status: CodexTaskStatusStore.Status) -> Color {
        ...
        case .waitingApproval: Color(red: 1.0, green: 0.67, blue: 0.22)
        case .waitingUserInput: Color(red: 0.78, green: 0.57, blue: 1.0)
    ...
    private var icon: String {
        ...
        case .waitingApproval: "checkmark.shield.fill"
        case .waitingUserInput: "questionmark.bubble.fill"
